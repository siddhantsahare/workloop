  ...
  return (
    <Segment clearing>
      ...
      <Header fluid="true" as="h2" floated="left" style={{ marginBottom: 0 }}>
        <span>
          {displayChannelName()}
          {!isPrivateChannel && <Icon name={"star outline"} color="black" style={{marginLeft: '5px'}}/>}
        </span>
        <Header.Subheader>{!isPrivateChannel ? numUniqueUsers : "Private Channel"}</Header.Subheader>
      </Header>
